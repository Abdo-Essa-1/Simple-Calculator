...
static uint8 KEYPAD_4x4_adjustKeyNumber(uint8 button_number)
{
	...
	switch(button_number)
	{
		...
		case 2: keypad_button = 2;
				break;
		case 3: keypad_button = '%'; // ASCII Code of %
				break;
		case 4: keypad_button = 3;
				break;
		case 5: keypad_button = 4;
				break;
		case 6: keypad_button = 5;
				break;
		case 7: keypad_button = '*';
				break;
		case 8: keypad_button = 6; /* ASCII Code of '*' */
				break;		
		case 9: keypad_button = 7;
				break;
		case 10: keypad_button = 8;
				break;
		case 11: keypad_button = '-'; /* ASCII Code of '-' */
				break;
		case 12: keypad_button = 9;
				break;
